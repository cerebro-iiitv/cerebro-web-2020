    ...
    <div className="cover">
      <div className="cover__social-links">
        <div className="cover__social-links__container">
          ...
          <a
            className="cover__social-links__link"
            href="https://www.facebook.com/cerebro.iiitv/"
            target="_blank"
          >
        ...
        <a className="cover__social-links__link down-arrow">
      ...
      <div className="cover__image">
        <img
          className="cover__image__bg-left"
          src="media/cover/cover-bg-left.png"
          alt="Cerebro helmet background"
        />
        <img
          className="cover__image__bg-right"
          src="media/cover/cover-bg-right.png"
          alt="Cerebro helmet background"
        />
        <img
          className="cover__image__helmet animation-space-float"
