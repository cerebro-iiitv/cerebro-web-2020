		...
		<div className="footer_u">
			...
			<div className="footer_l">
				<div className="footer_l__links">
					<div>
						<div className="footer_l__hr" ><h2>Links</h2><div className="footer_l__hr_text"><hr color="#25cbc0" /></div><br /><br /><br /></div>
					</div>
				...
				<div className="footer_l__contact">
					<div>
						<div className="footer_l__hr" ><h2>Contact</h2><div className="footer_l__hr_text"><hr color="#25cbc0" /></div><br /><br /><br /></div>
					</div>
					<div className="footer_l__links_content"><a className="footer_l__links_cn" >Email: cerebro@iiitv.ac.in                             </a></div>
					<div className="footer_l__links_content"><a className="footer_l__links_cn" >Phone: +91-9370645038</a></div>
					<div className="footer_l__links_content"><a className="footer_l__links_cn" >Address: c/o Block No.9, Government Engineering<div className="footer_l__gmap"> College, Sector-28, Gandhinagar, Gujarat - 382028</div></a></div>
				</div>
			</div>
		</div>
	);
